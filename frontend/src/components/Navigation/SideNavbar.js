      ...
      <div class="site-menubar">
        <div class="site-menubar-header">
          <div class="cover overlay">
            <img
              class="cover-image"
              src="../assets//examples/images/dashboard-header.jpg"
              alt="..."
            />
            ...
            <div>
              <ul class="site-menu" data-plugin="menu">
                  ...
                  <ul class="site-menu-sub">
                    <li class="site-menu-item">
                      <a
                        ...
                        href="layouts/menubar-fold.html"
                      >
                    ...
                    <li class="site-menu-item">
                      <a
                        class="animsition-link"
                        href="layouts/menubar-disable-hover.html"
                      >
                        <span class="site-menu-title">
                          Menubar Disable Hover
                        </span>
                      </a>
                    </li>
                    <li class="site-menu-item">
                      <a
                        class="animsition-link"
                        href="layouts/menubar-open.html"
                      >
                    ...
                    <li class="site-menu-item">
                      <a
                        class="animsition-link"
                        href="layouts/menubar-push.html"
                      >
                ...
                <li class="site-menu-item has-sub">
                  <a href="javascript:void(0)">
                    <i
                      class="site-menu-icon md-google-pages"
                      aria-hidden="true"
                    ></i>
                ...
                <li class="site-menu-item has-sub">
                  <a href="javascript:void(0)">
                    <i
                      class="site-menu-icon md-format-color-fill"
                      aria-hidden="true"
                    ></i>
                ...
                <li class="site-menu-item has-sub">
                  <a href="javascript:void(0)">
                    <i
                      class="site-menu-icon md-puzzle-piece"
                      aria-hidden="true"
                    ></i>
                ...
                <li class="site-menu-item has-sub">
                  <a href="javascript:void(0)">
                    <i
                      class="site-menu-icon md-border-all"
                      aria-hidden="true"
                    ></i>
